...
class IntelHero{
    ...
    public:
        ...
        friend bool compare(const StrengthHero &hero1, const IntelHero &hero2);//dideklarasi di global
        
        //bisa didalam
        friend bool compare(const IntelHero &hero1, const StrengthHero &hero2){//dideklarasi disini
